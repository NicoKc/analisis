        ...
        \item
            \begin{enumerate}
                ...
                \item $z = x^2 + y^2$
                    ...
                    \includegraphics[scale=0.4]{ej07/resources/1b.png} $ $
                ...
                \item $x^2 = y^2 + 4z^2$
                    ...
                    \includegraphics[scale=0.4]{ej07/resources/1e.png} $ $
                ...
                \item $z = x^2 - y^2$
                    ...
                    \includegraphics[scale=0.4]{ej07/resources/1f.png} $ $
                ...
                \item $x^2 + y^2 - z^2 = 1$
                    ...
                    \includegraphics[scale=0.4]{ej07/resources/1g.png} $ $
                ...
                \item $- x^2 - y^2 + z^2 = 1$
                    ...
                    \includegraphics[scale=0.4]{ej07/resources/1h.png} $ $
                ...
                \item $4x^2 + 9y^2 + z = 0$
                    ...
                    \includegraphics[scale=0.4]{ej07/resources/1i.png} $ $

            \end{enumerate}
        \item
            \begin{enumerate}
                \item $\frac{x^2}{a^2} + \frac{y^2}{b^2} + \frac{z^2}{c^2} = 1$
